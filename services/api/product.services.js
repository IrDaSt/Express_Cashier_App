...
// product by id join kategori
const getByIdAndKategori = async (id_produk) => {
    const rows = await mysqlconn.query(
        "Select * from produk inner join kategori on kategori.id_kategori = produk.id_kategori where produk.id_produk=?",
        [id_produk],
    )
    return rows
}
